...
class UserCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['last_name', 'first_name', 'patronymic', 'email', 'phone_number', 'password']
...
class UserPartialUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['id', 'last_name', 'first_name', 'patronymic', 'email', 'phone_number', 'password', 'password_confirmation']
